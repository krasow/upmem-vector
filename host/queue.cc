...
/*static*/ dpu_error_t upmem_start_callback( [[maybe_unused]] struct dpu_set_t stream,
                                             [[maybe_unused]] uint32_t rank_id, void *data)
{
  Event *me = (Event*)data;
...
void Event::add_completion_callback()
{
  ...
  CHECK_UPMEM(dpu_callback(dpu_set, &upmem_start_callback, (void *)this,
...
void EventQueue::add_fence(Event e) {
    auto& runtime = DpuRuntime::get();
    dpu_set_t& dpu_set = runtime.dpu_set();
    CHECK_UPMEM(dpu_callback(dpu_set, &upmem_start_callback, (void *)&e,
            (dpu_callback_flags_t)(DPU_CALLBACK_ASYNC | DPU_CALLBACK_NONBLOCKING |
                                   DPU_CALLBACK_SINGLE_CALL)));
